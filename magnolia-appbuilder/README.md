...
public class GuiceComponentConfigurer extends AbstractGuiceComponentConfigurer {
    ...
    protected void configure() {
        ...
        getClasses(Set.of(new AnnotationTypeFilter(SearchResultSupplier.class)), PACKAGES_TO_SCAN).forEach(clazz -> searchResultProviderMultibinder.addBinding().toInstance(clazz));
    }
}
```
...
@SearchResultSupplier(
        workspace = "<WORKSPACE>",
        nodeTypes = {NodeTypes.Folder.NAME}
)
