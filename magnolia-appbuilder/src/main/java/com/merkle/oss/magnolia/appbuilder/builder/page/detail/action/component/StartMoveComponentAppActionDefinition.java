...
public class StartMoveComponentAppActionDefinition implements AppActionDefinition {
    @Override
    public MoveComponentActionDefinition action(final DropConstraintDefinition dropConstraint) {
        ...
        definition.setName("startMoveComponent");
        definition.setStart(true);
        definition.setIcon(MagnoliaIcons.MOVE.getCssClass());
        definition.setAvailability(new AvailabilityDefinitionBuilder()
                .rule(new PermissionRequiredRuleDefinition(Permission.WRITE))
                .rule(new IsComponentMovableRuleDefinition())
